...
export const settings: SettingSchemaDesc[] = [
  ...
  {
    key: 'turnOffDefaultToolbar',
    type: 'boolean',
    default: true,
    title: 'Turn Off Default Toolbar',
    description: `If enabled, it turns off the journal home, go back and go forward icons in place of the plugin's toolbar.`,
  },
]
